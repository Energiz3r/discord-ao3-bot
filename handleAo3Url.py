...
async def handleAo3Url(message):
    url = 'https://archiveofourown.org/' + find_between(message.content + ' ', 'archiveofourown.org/', ' ')
    ...
    if hasWorkBeenPosted(workId):
        ...
        embed.set_footer(
            text = 'Fic last updated: ' + story['lastUpdated'] + ' | Bot trouble? Hit up Tangles#6014 | WorkID: ' + story['workId']
        )
...
#def letsGo():
    #handleAo3Url('this works quite nicely I think:https://archiveofourown.org/works/41537028/chapters/104176614 what do you think guys?')
#letsGo()